...
def test_required_env_vars(capsys, mocker):
    ...
    # CDB_TEST_RESULTS_DIR has a default, '/data/junit/' but this is not checked
    ...
    set_env_vars = {
        'CDB_ARTIFACT_GIT_URL': 'https://bitbucket.org/None/None/commits/abc50c8a53f79974d615df335669b59fb56a4ed3',
        'CDB_ARTIFACT_GIT_COMMIT': 'abc50c8a53f79974d615df335669b59fb56a4ed3',
        'CDB_BUILD_NUMBER': '127',
